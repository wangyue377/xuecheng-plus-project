...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\develop\\xuecheng\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\develop\\upload\\1a.avi";
    String mp4_name = "1b.mp4";
    String mp4folder_path = "D:\\develop\\upload\\1b.mp4";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mp4_name = "1b.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\develop\\upload\\1b.mp4";
        //创建工具类对象
